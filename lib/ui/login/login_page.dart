                            ...
                            children: [
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: "Email",
                                      errorText: authProvider.isValueNotAvailable ? "Email Required" : null,
                             ...
                             Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: "Password",
                                       errorText: authProvider.isValueNotAvailable ? "Password Required" : null,
                                      hintStyle:  const TextStyle(color: Colors.grey),
                                      border: InputBorder.none
                                  ),
                                ),
                        ...
                        GestureDetector(
                          onTap: (){
                            ...
                            if(!authProvider.isValueNotAvailable){
                              ...
                              authProvider.login(context).then((value) =>  EasyLoading.dismiss());
                            }
                          },
                          child: Container(
                            height: 50,
